...
#define PUBLIC_PHRASE 			"10/04/2019 Deutsche Bank CEO wants more time to assess Commerzbank merger - Die Welt"	//+
#define PUBLIC_KEY 				"046090fcb13b5c042bad9bbb74ad1e708d87805bf599b19fa70261e97786b814d8fa91eac3bce5558743f42cb39b1c044ca0ae4702a840253b1e01025d39e0c8b3"	//+
#define GENESIS_MAIN_TIME 		1555341315UL		//+
#define GENESIS_TEST_TIME		1555341316UL		//+
#define GENESIS_RTEST_TIME		1555341317UL		//+
#define GENESIS_HASH_MERKL 		"5610c01cfd7015ee1dc3aa03d5eed8ec3a706b656288560066248b71dde23fdd"		//+

#define GENESIS_MAIN_HASH 		"0x0000075390c64f7a2485f1f3c2c3b33ece555cbc1f83aaf8b0e6cae40fb52733"	//+
#define GENESIS_MAIN_NONCE 		178774UL																//+
#define GENESIS_TEST_HASH 		"0x00000baddc5c2465e2936fdacdd58138a4b2ce3ee198a7d6b94587bd9dd7640d"	//+
#define GENESIS_TEST_NONCE 		1166782UL																//+
#define GENESIS_RTEST_HASH		"0x2bfde91b501202ee8e255c6f4f268f9aecc1c58e2374e0df3e400040abfe517a"	//+
...
//TODO:
        ...
        vAlertPubKey = ParseHex("04965940b03573326d59f8be2402e09ef052e5a1b96fb8de09ebe7185387d846d3fec53fbe66e94211bad638a8930c6ecfb0681a315e5c118257b1b4328ff8422c");
        nDefaultPort = 4244;
        ...
        // Beenode script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,8);
        // Beenode private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,27);
        // Beenode BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Beenode BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // Beenode BIP44 coin type is '5'
        nExtCoinType = 5;
...
public:
    CTestNetParams() {
        ...
        // Testnet Beenode script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Beenode BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Beenode BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
...
public:
    CRegTestParams() {
        ...
        // Regtest Beenode addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Beenode script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Beenode BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Beenode BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
